...
function Profile() {
	...
	useEffect(() => {
		...
		if (userInfo.isAdmin == true) return router.push('/admins/users/');
			...
			<Grid container spacing={1}>
				<Grid item md={3} xs={12}>
					<Card className={classes.section}>
						<List>
							<NextLink href="/users/profile" passHref>
								<ListItem selected button component="a">
									<ListItemText primary="User Profile"></ListItemText>
								</ListItem>
							</NextLink>
							<NextLink href="/users/upload" passHref>
								<ListItem button component="a">
									<ListItemText primary="Upload Document"></ListItemText>
								</ListItem>
							</NextLink>
						</List>
					</Card>
